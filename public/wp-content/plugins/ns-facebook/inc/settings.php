...
function nsfb_add_settings_page_to_menu() {
	add_submenu_page(
		...
		'Nameless Sheep Facebook Settings', // page title
		'Facebook', // menu title
...
function nsfb_settings_init() {
	...
	add_settings_field(
		'nsfb_token', // id
		'Facebook api access token:', // label
...
function nsfb_general_options_section() {
	?>
		<p>Section for settings for the Facebook plugin.</p>
	<?php
}
...
function nsfb_title_cb() {
	?>
		<input
			...
			name="nsfb_title"
			id="nsfb_title"
			value="<?php echo get_option('nsfb_title', 'Facebook'); ?>"
		>
	<?php
}
